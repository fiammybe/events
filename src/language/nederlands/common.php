...
define("_CO_EVENTS_EVENT_IMAGE", "Afbeelding");
define("_CO_EVENTS_EVENT_IMAGE_DSC", "Een afbeelding voor het event");
define("_CO_EVENTS_EVENT_PROMOIMAGE1", "Achtergrond Foto");
define("_CO_EVENTS_EVENT_PROMOIMAGE1_DSC", "Een achtergrond foto voor het event");
