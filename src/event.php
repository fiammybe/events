...
function display_tags($eventObj, $sprockets_taglink_handler, $events_event_handler)
{
    $event_tags = array();
...
function display_event($eventObj, $events_event_handler)
{
    global $icmsTpl, $xoTheme;

    // Prepare tags for display
    /*if (icms_get_module_status("sprockets"))
    {
        display_tags($eventObj, $sprockets_taglink_handler, $events_event_handler);
    }*/
...
function display_event_index($eventObj, $events_event_handler)
{
    global $icmsTpl;
...
if ($eventObj && !$eventObj->isNew()) {
	...
	display_event($eventObj, $events_event_handler);
} else {
	////////////////////////////////////////////////////////////////////////
	////////// Display event index page, sorted by year and month //////////
	////////////////////////////////////////////////////////////////////////
display_event_index($eventObj, $events_event_handler);
